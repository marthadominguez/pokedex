...
const Footer = () => {
  return (
    <footer className="fixed flex items-center justify-center text-xs top-1/2 -left-28 rotate-90 w-64 h-6 text-slate-400 tracking-wider rounded-t-lg text-sm sm:text-lg sm:w-72 sm:h-8 sm:-left-32 sm:bg-slate-300 sm:text-slate-500">
